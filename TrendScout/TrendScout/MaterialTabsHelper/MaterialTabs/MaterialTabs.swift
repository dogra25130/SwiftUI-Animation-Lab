...
public struct MaterialTabs<HeaderTitle, HeaderTabBar, HeaderBackground, Content, Tab>: View
    ...
    public init(
        ...
        self.init(
            isHeaderStrechy: isHeaderStrechy,
    ...
    public init(
        ...
        _headerModel = StateObject(wrappedValue: HeaderModel(selectedTab: selectedTab.wrappedValue, isHeaderStrechy: isHeaderStrechy))
    }
